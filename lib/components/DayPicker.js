...
function (_ref) {
  ...
  _proto.render = function render() {
    ...
    var activePeriod = "Optimierungszeitraum ".concat(currentMonth.month() + 1, " (KW ").concat(currentMonth.week(), " - KW ").concat(currentMonth.week() + (this.calendarMonthWeeks && this.calendarMonthWeeks[0]) - 2, ")");
    var verticalScrollable = orientation === _constants.VERTICAL_SCROLLABLE;
    var height;
