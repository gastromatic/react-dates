...
function (_ref) {
  ...
  _proto.render = function render() {
    ...
    var firstWeek = currentMonth.clone().startOf('month').startOf('isoWeek').week() + 1;
    var activePeriod = "Optimierungszeitraum ".concat(currentMonth.month() + 1, " (KW ").concat(firstWeek, " - KW ").concat(firstWeek + (this.calendarMonthWeeks && this.calendarMonthWeeks[0]) - 2, ")");
    var verticalScrollable = orientation === _constants.VERTICAL_SCROLLABLE;
    var height;
    ...
    return _react["default"].createElement("div", (0, _extends2["default"])({
      ...
      "aria-hidden": "true",
      role: "presentation"
    }), weekHeaders), activePeriod && false && _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.DayPicker_activePeriod), {
      "aria-hidden": "true",
      role: "presentation"
    }), activePeriod), _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.DayPicker_focusRegion), {
