...
function (_ref) {
  ...
  _proto.setCalendarInfoRefSecond = function setCalendarInfoRefSecond(ref) {
  ...
  _proto.renderWeekHeader = function renderWeekHeader(index) {
    ...
    var verticalStyle = {
      marginLeft: -calendarMonthWidth / 2 - 63
    };
    ...
    var firstDayOfWeek = this.getFirstDayOfWeek();
    var header = [_react["default"].createElement("li", (0, _extends2["default"])({
      key: "-1"
    ...
    for (var i = 0; i < 7; i += 1) {
      header.push(_react["default"].createElement("li", (0, _extends2["default"])({
        ...
        width: daySize
      })), (0, _moment["default"])().day((i + firstDayOfWeek) % 7).format(weekDayFormat)));
    }
  ...
  _proto.render = function render() {
    ...
    var _this$props11 = this.props,
        ...
        renderCalendarInfoSecond = _this$props11.renderCalendarInfoSecond,
        ...
        calendarInfoPositionSecond = _this$props11.calendarInfoPositionSecond,
        ...
        noBorderPicker = _this$props11.noBorderPicker,
        ...
        onDatesChange = _this$props11.onDatesChange,
        ...
        showAllCaptions = _this$props11.showAllCaptions,
        hideWeekHeader = _this$props11.hideWeekHeader,
        startDate = _this$props11.startDate,
        endDate = _this$props11.endDate,
        missingWeeks = _this$props11.missingWeeks,
        onFocusChange = _this$props11.onFocusChange,
        monthIndex = _this$props11.monthIndex,
        caption = _this$props11.caption;
    ...
    var calendarInfoPositionBottom = calendarInfoPosition === _constants.INFO_POSITION_BOTTOM || calendarInfoPositionSecond === _constants.INFO_POSITION_BOTTOM;
    ...
    var calendarInfoSecond = renderCalendarInfoSecond && _react["default"].createElement("div", (0, _reactWithStyles.css)(calendarInfoIsInline && styles.DayPicker_calendarInfo__horizontal), renderCalendarInfoSecond());
    ...
    return _react["default"].createElement("div", (0, _extends2["default"])({
    ...
    }, (0, _reactWithStyles.css)(styles.DayPicker, isHorizontal && styles.DayPicker__horizontal, verticalScrollable && styles.DayPicker__verticalScrollable, isHorizontal && withPortal && styles.DayPicker_portal__horizontal, this.isVertical() && withPortal && styles.DayPicker_portal__vertical, dayPickerStyle, !monthTitleHeight && styles.DayPicker__hidden, !noBorderPicker && styles.DayPicker__withBorder)), _react["default"].createElement(_reactOutsideClickHandler["default"], {
      onOutsideClick: onOutsideClick
    }, (calendarInfoPositionTop || calendarInfoPositionBefore) && calendarInfo, _react["default"].createElement("div", (0, _reactWithStyles.css)(dayPickerWrapperStyle, calendarInfoIsInline && isHorizontal && styles.DayPicker_wrapper__horizontal), !hideWeekHeader && _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.DayPicker_weekHeaders, isHorizontal && styles.DayPicker_weekHeaders__horizontal), {
      "aria-hidden": "true",
      role: "presentation"
      ...
      role: "region",
      tabIndex: -1
    }), !verticalScrollable && this.renderNavigation('top', 'prev'), !verticalScrollable && this.renderNavigation('bottom', 'next'), _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.DayPicker_transitionContainer, verticalHeight === 0 && styles.DayPicker_transitionContainer__auto, shouldAnimateHeight && styles.DayPicker_transitionContainer__horizontal, this.isVertical() && styles.DayPicker_transitionContainer__vertical, verticalScrollable && styles.DayPicker_transitionContainer__verticalScrollable, transitionContainerStyle), {
    ...
    }))), (calendarInfoPositionBottom || calendarInfoPositionAfter) && !calendarInfoSecond && calendarInfo, (calendarInfoPositionBottom || calendarInfoPositionAfter) && calendarInfoSecond));
  };
