...
function (_ref) {
  ...
  _proto.render = function render() {
    ...
    console.log('currentMonth', currentMonth && currentMonth.format('DD MM'), currentMonth && currentMonth.clone().startOf('month').startOf('isoWeek').week());
    ...
    return _react["default"].createElement("div", (0, _extends2["default"])({
      ...
      "aria-hidden": "true",
      role: "presentation"
    }), weekHeaders), activePeriod && _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.DayPicker_activePeriod), {
      "aria-hidden": "true",
      role: "presentation"
