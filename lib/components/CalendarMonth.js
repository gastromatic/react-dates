...
function (_ref) {
  ...
  _proto.render = function render() {
    ...
    return _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.CalendarMonth, {
      ...
      isVisible: isVisible
    }) : _react["default"].createElement("strong", null)), _react["default"].createElement("table", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(!verticalBorderSpacing && styles.CalendarMonth_table, verticalBorderSpacing && styles.CalendarMonth_verticalSpacing, verticalBorderSpacing && {
      ...
      }, i === 0 && Number(week[0] && week[0].date()) < 8 ? monthTitle : '', i === weeks.length - 1 && Number(week[6] && week[6].date()) < 7 ? month.clone().add(1, 'month').format(monthFormat) : '')), lastInvalidWeek === i ? _react["default"].createElement(_CalendarWeek["default"], {
        key: "".concat(i, "_error")
      }, _react["default"].createElement("td", null), _react["default"].createElement("td", (0, _extends2["default"])({
        colSpan: 7
      }, (0, _reactWithStyles.css)(styles.CalendarMonth_errorPeriod)), "Error message placeholder"), _react["default"].createElement("td", null)) : null] : null;
    }))));
  };
