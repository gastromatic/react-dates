...
function (_ref) {
  ...
  _proto.setWeek = function setWeek(_ref2) {
    ...
    var onDatesChange = this.props.onDatesChange;
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        dayAriaLabelFormat = _this$props3.dayAriaLabelFormat,
        daySize = _this$props3.daySize,
        focusedDate = _this$props3.focusedDate,
        horizontalMonthPadding = _this$props3.horizontalMonthPadding,
        ...
        onDayClick = _this$props3.onDayClick,
        onDayMouseEnter = _this$props3.onDayMouseEnter,
        onDayMouseLeave = _this$props3.onDayMouseLeave,
        onMonthSelect = _this$props3.onMonthSelect,
        onYearSelect = _this$props3.onYearSelect,
        orientation = _this$props3.orientation,
        phrases = _this$props3.phrases,
        renderCalendarDay = _this$props3.renderCalendarDay,
        renderDayContents = _this$props3.renderDayContents,
        renderMonthElement = _this$props3.renderMonthElement,
        renderMonthText = _this$props3.renderMonthText,
        styles = _this$props3.styles,
        verticalBorderSpacing = _this$props3.verticalBorderSpacing,
        errorMessage = _this$props3.errorMessage,
        showAllCaptions = _this$props3.showAllCaptions,
        monthIndex = _this$props3.monthIndex;
    ...
    var firstWeekIndex = currentMonth.clone().startOf('month').startOf('isoWeek').week() + (isFirstDay ? 0 : 1);
    var lastDayIndex = currentMonth.clone().endOf('month').endOf('isoWeek').date();
    var lastWeekIndex = currentMonth.clone().endOf('month').endOf('isoWeek').week() - 1;
    ...
    var displayCaption = showAllCaptions || monthIndex === 1 && !showAllCaptions;
    return _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.CalendarMonth, {
      ...
      "aria-hidden": "true",
      role: "presentation"
    }), activePeriod)), _react["default"].createElement("table", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(!verticalBorderSpacing && styles.CalendarMonth_table, verticalBorderSpacing && styles.CalendarMonth_verticalSpacing, verticalBorderSpacing && {
      borderSpacing: "0px ".concat(verticalBorderSpacing, "px")
    }), {
      role: "presentation"
    }), _react["default"].createElement("tbody", null, weeks.map(function (week, i) {
      return !(i === 0 && Number(week[0] && week[0].date()) > 7) ? [_react["default"].createElement(_CalendarWeek["default"], {
        key: i
      ...
      }, i === 0 && Number(week[0] && week[0].date()) > 7 ? '' : "".concat(week[0] && week[0].week())), week.map(function (day, dayOfWeek) {
      ...
      }, i === 0 && Number(week[0] && week[0].date()) < 8 ? monthTitle : '', i === weeks.length - 1 && Number(week[6] && week[6].date()) < 7 ? month.clone().add(1, 'month').format(monthFormat) : '')), lastInvalidWeek === i && errorMessage ? _react["default"].createElement(_CalendarWeek["default"], {
        key: "".concat(i, "_error")
      }, _react["default"].createElement("td", {
        style: {
          width: 10
