...
function (_ref) {
  ...
  function CalendarMonth(props) {
    ...
    _this.getLastInvalidWeek = _this.getLastInvalidWeek.bind((0, _assertThisInitialized2["default"])(_this));
    return _this;
  }
  ...
  _proto.getLastInvalidWeek = function getLastInvalidWeek() {
  ...
  _proto.render = function render() {
    ...
    var lastInvalidWeek = this.getLastInvalidWeek();
    ...
    var activePeriod = "".concat(caption, " ").concat(currentMonth.month() + 1, " (KW ").concat(firstWeekIndex, " - KW ").concat(lastWeekIndex, ")");
    var currentMonthIndex = currentMonth.month();
    var startWeekMonth = startDate && startDate.clone().startOf('isoWeek').month();
    var startWeekCurrentMonth = currentMonth && currentMonth.clone().startOf('isoWeek').month();
    var displayCaption = showAllCaptions || !showAllCaptions && !startDate && monthIndex === 1 || startDate && (startDate.month() === currentMonthIndex && currentMonthIndex === startWeekMonth || startDate.month() === currentMonthIndex + 1 && startWeekMonth === startDate.clone().subtract(1, 'month').month());
    var startWeek = null;
    return _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.CalendarMonth, {
      ...
      var res = !(i === 0 && Number(week[0] && week[0].date()) > 7) ? [_react["default"].createElement(_CalendarWeek["default"], {
        ...
        className: "".concat(styles.CalendarMonth_weekNumber, " ").concat(week[0] && missingWeeks && missingWeeks["".concat(week[0] && week[0].year()).concat(week[0] && week[0].isoWeek())] ? 'missingWeek' : ''),
      ...
      }), _react["default"].createElement("td", null, i === 0 && Number(week[0] && week[0].date()) < 8 || startWeek === null && monthIndex === 1 ? _react["default"].createElement("div", null, monthTitle) : '', i === weeks.length - 1 && Number(week[6] && week[6].date()) < 7 ? _react["default"].createElement("div", null, month.clone().add(1, 'month').format(monthFormat), _react["default"].createElement("div", {
        className: "divider"
      })) : '')), lastInvalidWeek === i && lastPeriodMonth && errorMessage ? _react["default"].createElement(_CalendarWeek["default"], {
        key: "".concat(i, "_error")
      }, _react["default"].createElement("td", {
        className: styles.CalendarMonth_invalidWeek
