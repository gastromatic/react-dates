...
function (_ref) {
  ...
  _proto.render = function render() {
    ...
    return _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.CalendarMonth, {
      ...
      }, i === 0 && Number(week[0] && week[0].date()) < 8 ? _react["default"].createElement("div", null, monthTitle, _react["default"].createElement("div", {
        className: "divider"
      })) : '', i === weeks.length - 1 && Number(week[6] && week[6].date()) < 7 ? _react["default"].createElement("div", null, month.clone().add(1, 'month').format(monthFormat), _react["default"].createElement("div", {
        className: "divider"
