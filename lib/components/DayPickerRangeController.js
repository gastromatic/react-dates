...
var defaultProps = {
  ...
  isInInvalidSpan: function isInInvalidSpan() {},
  // DayPicker props
...
function (_React$Component) {
  ...
  _proto.isInInvalidSpan = function isInInvalidSpan(day) {
    ...
    var endDate = initialEndDate || currentEndDate;
    var month = day.clone().startOf('isoWeek').month();
    return day.isBetween(startDate, endDate, 'days') && startDate && (day.month() !== startDate.month() || day.month() === startDate.month() && startDate.clone().startOf('isoWeek').month() != startDate.month()) && (month == day.month() || month != day.month() && month == day.clone().subtract(1, 'month').month() && month > startDate.month());
  };
