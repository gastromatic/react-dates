...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  noBorderPicker: _propTypes["default"].bool,
  hideWeekHeader: _propTypes["default"].bool,
  ...
  renderCalendarInfoSecond: _propTypes["default"].func,
  renderKeyboardShortcutsButton: _propTypes["default"].func,
  calendarInfoPosition: _CalendarInfoPositionShape["default"],
  calendarInfoPositionSecond: _CalendarInfoPositionShape["default"],
  ...
  onChangeModifiers: _propTypes["default"].func,
  onMonthIndexChanged: _propTypes["default"].func,
  monthIndex: _airbnbPropTypes.nonNegativeInteger,
...
var defaultProps = {
  ...
  calendarInfoPosition: _constants.INFO_POSITION_TOP,
  calendarInfoPositionSecond: _constants.INFO_POSITION_BOTTOM,
  firstDayOfWeek: null,
  verticalHeight: null,
  noBorder: false,
...
function (_React$Component) {
  (0, _inheritsLoose2["default"])(DayPickerRangeController, _React$Component);
  ...
  function DayPickerRangeController(props) {
    ...
    _this.modifiers = {
      ...
      'selected-invalid-end': function selectedInvalidEnd(day) {
        return _this.isEndInvalidDate(day);
      },
      ...
      'invalid-span': function invalidSpan(day) {
        return _this.isInInvalidSpan(day);
      },
      'missed-span': function missedSpan(day) {
        return _this.isInMissingSpan(day);
      },
    ...
    _this.isInMissingSpan = _this.isInMissingSpan.bind((0, _assertThisInitialized2["default"])(_this));
    _this.updateModifiersParent = _this.updateModifiersParent.bind((0, _assertThisInitialized2["default"])(_this));
    return _this;
  }
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (didStartDateChange || didEndDateChange) {
      ...
      if (prevStartDate && prevEndDate) {
        modifiers = this.deleteModifierFromRange(modifiers, prevStartDate, prevEndDate.clone().add(1, 'day'), 'invalid-span');
        modifiers = this.deleteModifierFromRange(modifiers, prevStartDate, prevEndDate.clone().add(1, 'day'), 'selected-invalid-end');
      }
    }
    ...
    if (didFocusChange || recomputePropModifiers) {
      (0, _object["default"])(visibleDays).forEach(function (days) {
        Object.keys(days).forEach(function (day) {
          ...
          if (_this2.isInInvalidSpan(momentObj, startDate, endDate)) {
            modifiers = _this2.addModifier(modifiers, momentObj, 'invalid-span');
          } else {
            modifiers = _this2.deleteModifier(modifiers, momentObj, 'invalid-span');
          }

          if (_this2.isEndInvalidDate(momentObj, startDate, endDate)) {
            modifiers = _this2.addModifier(modifiers, momentObj, 'selected-invalid-end');
          } else {
            modifiers = _this2.deleteModifier(modifiers, momentObj, 'selected-invalid-end');
          }
        });
      });
    }
  ...
  _proto.onDayClick = function onDayClick(day, e, monthIndex) {
    var _this$props2 = this.props,
        ...
        missingWeeks = _this$props2.missingWeeks,
        onMonthIndexChanged = _this$props2.onMonthIndexChanged;
  ...
  _proto.getModifiers = function getModifiers(visibleDays) {
    ...
    Object.keys(visibleDays).forEach(function (month) {
      ...
      visibleDays[month].forEach(function (day) {
        modifiers[month][(0, _toISODateString["default"])(day)] = _this11.getModifiersForDay(day);
      });
    });
    return modifiers;
  };
  ...
  _proto.getModifiersForDay = function getModifiersForDay(day) {
    ...
    return new Set(Object.keys(this.modifiers).filter(function (modifier) {
      return _this12.modifiers[modifier](day);
    }));
  };
  ...
  _proto.isEndInvalidDate = function isEndInvalidDate(day) {
    var initialStartDate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    var initialEndDate = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    var _this$props16 = this.props,
        currentStartDate = _this$props16.currentStartDate,
        currentEndDate = _this$props16.currentEndDate;
    var startDate = initialStartDate || currentStartDate;
    var endDate = initialEndDate || currentEndDate;
    var month = day.clone().startOf('isoWeek').month();
    return (0, _isSameDay["default"])(day, endDate) && startDate && (day.month() !== startDate.month() || day.month() === startDate.month() && startDate.clone().startOf('isoWeek').month() != startDate.month()) && (month == day.month() || month != day.month() && month == day.clone().subtract(1, 'month').month() && month > startDate.month());
  };
  ...
  _proto.isInInvalidSpan = function isInInvalidSpan(day) {
    var initialStartDate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    var initialEndDate = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    var _this$props19 = this.props,
        currentStartDate = _this$props19.currentStartDate,
        currentEndDate = _this$props19.currentEndDate;
    var startDate = initialStartDate || currentStartDate;
    var endDate = initialEndDate || currentEndDate;
    var month = day.clone().startOf('isoWeek').month();
    return day.isBetween(startDate, endDate, 'days') && startDate && (day.month() !== startDate.month() || day.month() === startDate.month() && startDate.clone().startOf('isoWeek').month() != startDate.month() || day.month() === startDate.month() && startDate.clone().startOf('isoWeek').month() === startDate.month() && month < startDate.month()) && (month == day.month() || month != day.month() && month == day.clone().subtract(1, 'month').month() && month >= startDate.month() && startDate.clone().startOf('isoWeek').month() != startDate.month() || month != day.month() && startDate.clone().startOf('isoWeek').month() + 1 < day.month());
  };

  _proto.isInMissingSpan = function isInMissingSpan(day) {
    var missingWeeks = this.props.missingWeeks;
    var key = day ? "".concat(day.year()).concat(day.isoWeek()) : '';
  ...
  _proto.updateModifiersParent = function updateModifiersParent() {
    this.props.onChangeModifiers(_objectSpread({}, this.state.visibleDays));
  };

  _proto.render = function render() {
    var _this$props22 = this.props,
        startDate = _this$props22.startDate,
        endDate = _this$props22.endDate,
        ...
        renderCalendarInfoSecond = _this$props22.renderCalendarInfoSecond,
        renderMonthElement = _this$props22.renderMonthElement,
        calendarInfoPosition = _this$props22.calendarInfoPosition,
        calendarInfoPositionSecond = _this$props22.calendarInfoPositionSecond,
        ...
        isDayBlocked = _this$props22.isDayBlocked,
        isOutsideRange = _this$props22.isOutsideRange,
        errorMessage = _this$props22.errorMessage,
        noBorderPicker = _this$props22.noBorderPicker,
        hideWeekHeader = _this$props22.hideWeekHeader,
        showAllCaptions = _this$props22.showAllCaptions,
        missingWeeks = _this$props22.missingWeeks,
        onFocusChange = _this$props22.onFocusChange,
        initialVisibleMonth = _this$props22.initialVisibleMonth,
        monthIndex = _this$props22.monthIndex,
        caption = _this$props22.caption;
