...
function (_React$Component) {
  ...
  _proto.isEndInvalidDate = function isEndInvalidDate(day) {
    ...
    return (0, _isSameDay["default"])(day, endDate) && startDate && (day.month() !== startDate.month() || day.month() === startDate.month() && startDate.clone().startOf('isoWeek').month() != startDate.month()) && (day.clone().startOf('isoWeek').month() == day.month() || day.clone().startOf('isoWeek').month() != day.month() && day.clone().startOf('isoWeek').month() == day.clone().subtract(1, 'month').month() && day.clone().startOf('isoWeek').month() > startDate.month());
  };
  ...
  _proto.isInInvalidSpan = function isInInvalidSpan(day) {
    ...
    return day.isBetween(startDate, endDate, 'days') && startDate && (day.month() !== startDate.month() || day.month() === startDate.month() && startDate.clone().startOf('isoWeek').month() != startDate.month()) && (day.clone().startOf('isoWeek').month() == day.month() || day.clone().startOf('isoWeek').month() != day.month() && day.clone().startOf('isoWeek').month() == day.clone().subtract(1, 'month').month() && day.clone().startOf('isoWeek').month() > startDate.month());
  };
