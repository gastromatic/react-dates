...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)(_objectSpread({}, _reactWithStyles.withStylesPropTypes, {}, _DateRangePickerShape["default"], {
  ...
  calendarInfoPositionSecond: _propTypes["default"].string,
  emptyPeriodMessage: _propTypes["default"].string,
...
function (_ref) {
  ...
  _proto.renderDayPicker = function renderDayPicker() {
    var _this$props7 = this.props,
        ...
        renderCalendarInfoSecond = _this$props7.renderCalendarInfoSecond,
        renderMonthElement = _this$props7.renderMonthElement,
        calendarInfoPosition = _this$props7.calendarInfoPosition,
        calendarInfoPositionSecond = _this$props7.calendarInfoPositionSecond,
        ...
        missingWeeks = _this$props7.missingWeeks,
        errorMessage = _this$props7.errorMessage,
        reactDates = _this$props7.theme.reactDates,
        noBorderPicker = _this$props7.noBorderPicker,
        hideWeekHeader = _this$props7.hideWeekHeader,
        showAllCaptions = _this$props7.showAllCaptions,
        onChangeModifiers = _this$props7.onChangeModifiers,
        onMonthIndexChanged = _this$props7.onMonthIndexChanged,
        monthIndex = _this$props7.monthIndex,
        caption = _this$props7.caption;
    ...
    return _react["default"].createElement("div", (0, _extends2["default"])({
      ...
      top: 0 // previous value: inputHeight + verticalSpacing
