...
function getMonths(initialMonth, numberOfMonths, withoutTransitionMonths, monthIndex) {
  ...
  var initialMonthIndex = month.month();
  var startWeekMonth = month.clone().startOf('isoWeek').month();
  var isInvalidPeriod = (initialMonthIndex !== monthIndex || initialMonthIndex === monthIndex && startWeekMonth != monthIndex) && (startWeekMonth == monthIndex || startWeekMonth != monthIndex && startWeekMonth == month.clone().subtract(1, 'month').month() && startWeekMonth > monthIndex);
...
function (_ref) {
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    var initialMonth = nextProps.initialMonth,
        ...
        monthIndex = nextProps.monthIndex;
    ...
    if (hasNumberOfMonthsChanged) {
      ...
      newMonths = getMonths(initialMonth, numberOfMonths, _withoutTransitionMonths, monthIndex);
    }
  ...
  _proto.render = function render() {
    ...
    var _this$props5 = this.props,
        ...
        showAllCaptions = _this$props5.showAllCaptions,
        startDate = _this$props5.startDate,
        endDate = _this$props5.endDate,
        missingWeeks = _this$props5.missingWeeks,
    ...
    var calendarMonthWidth = (0, _getCalendarMonthWidth["default"])(daySize, horizontalMonthPadding) + _constants.MONTH_NAME_SPACER;

    var width = isVertical || isVerticalScrollable ? calendarMonthWidth : (numberOfMonths + 2) * calendarMonthWidth;
    var weeks = (0, _getCalendarMonthWeeks["default"])(months[translationValue > 0 ? 0 : 1], enableOutsideDays, firstDayOfWeek == null ? _moment["default"].localeData().firstDayOfWeek() : firstDayOfWeek);
    var weekNumber = 0;
    ...
    var delta = 33;
    var tr = translationValue > 0 ? translationValue : translationValue < 0 ? translationValue + delta : 0;
    var transformType = isVertical || isVerticalScrollable ? 'translateY' : 'translateX';
    var transformValue = "".concat(transformType, "(").concat(tr, "px)");
    return _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.CalendarMonthGrid, isHorizontal && styles.CalendarMonthGrid__horizontal, isVertical && styles.CalendarMonthGrid__vertical, isVerticalScrollable && styles.CalendarMonthGrid__vertical_scrollable, isAnimating && styles.CalendarMonthGrid__animating, isAnimating && transitionDuration && {
      ...
      var weeks = (0, _getCalendarMonthWeeks["default"])(month, enableOutsideDays, firstDayOfWeek == null ? _moment["default"].localeData().firstDayOfWeek() : firstDayOfWeek);
      var weekNumber = 0;
      weeks.forEach(function (week, i) {
        if (i == 0 && Number(week[0] && week[0].date()) === 1 || i > 0) {
          weekNumber++;
      ...
      var topMargin = weekNumber * 30 + 30 || 0;
      return _react["default"].createElement("div", (0, _extends2["default"])({
        key: monthString
      }, (0, _reactWithStyles.css)(isHorizontal && styles.CalendarMonthGrid_month__horizontal, hideForAnimation && styles.CalendarMonthGrid_month__hideForAnimation, hideForAnimation && {
        marginTop: -1 * topMargin
